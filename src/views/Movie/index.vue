    ...
    <div id="content">
      <div class="movie_menu">
        ...
        <div class="hot_swtich">
          <router-link tag="div" to="/movie/NowPlaying" class="hot_item">nowplaying</router-link>
          <router-link tag="div" to="/movie/ComingSoon" class="hot_item">comingsoon</router-link>
        </div>
